...
public static class BuildDLLCommand
{
    ...
    [MenuItem("HybridCLR/Build/BuildAssets And CopyTo AssemblyTextAssetPath Then Build AssetBundle")]
    public static void BuildAndCopyDllsThenBuildAB()
    {
#if ENABLE_HYBRIDCLR
        BuildTarget target = EditorUserBuildSettings.activeBuildTarget;
        CompileDllCommand.CompileDll(target);
        CopyAOTHotUpdateDlls(target);
        ReleaseTools.BuildCurrentPlatformAB();
#endif
    }
